...
class ClientMainWindow(QMainWindow):
    ...
    def __init__(self, database, transport, keys, status):
        super().__init__()
        # основные переменные
    ...
    def message(self, message):
        ...
        sender = message[os.getenv('SENDER')]
    ...
    def make_connection(self, trans_obj):
        ...
        print("///CLN_MC_1", trans_obj)
        trans_obj.new_message.connect(self.message)
        print("///CLN_MC_2", trans_obj)
