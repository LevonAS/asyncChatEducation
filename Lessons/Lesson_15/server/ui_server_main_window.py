...
from server.ui_stat_window import StatWindow
from server.ui_config_window import ConfigWindow
from server.ui_add_user import RegisterUser
from server.ui_remove_user import DelUserDialog
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, database, server, config):
        ...
        self.setWindowTitle('Messaging Server Auuu')
        ...
        self.active_clients_table.move(20, 55)
