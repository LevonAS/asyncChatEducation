...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./lib/client/icons/biaoqing_008.png"),
        ...
        icon1.addPixmap(QtGui.QPixmap(
            "./lib/client/icons/biaoqing_009.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2.addPixmap(QtGui.QPixmap(
            "./lib/client/icons/biaoqing_014.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3.addPixmap(QtGui.QPixmap(
            "./lib/client/icons/biaoqing_018.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
